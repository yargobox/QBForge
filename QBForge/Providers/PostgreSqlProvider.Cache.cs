...
namespace QBForge.Providers
{
	...
	{
		/// <summary>
		/// Is it one of the known SQL keywords? Only lower case values are allowed.
		/// </summary>
		/// <param name="value">Lower case word</param>
		private static bool IsKnownKeyword(string value)
		{
			return Cache.Keywords.Contains(value);
		}
		...
		private static class Cache
		{
			...
			public static readonly HashSet<string> Keywords = new()
			{
				...
				"prune",
				"ptf",
				//"public", // Do not mess up with it, as it is commonly used without any problems
				"publication",
				"quote",
				"quotes",
				"range",
