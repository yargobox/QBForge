...
namespace QBForge.Provider.Clauses
{
    public class RightJoinClause : BinaryClause
	{
		...
		public RightJoinClause(TableClause tableClause, string labelAs) : this(tableClause, new OnClause(), labelAs) { }
		public RightJoinClause(SubQueryClause subQueryClause, string labelAs) : this(subQueryClause, new OnClause(), labelAs) { }
