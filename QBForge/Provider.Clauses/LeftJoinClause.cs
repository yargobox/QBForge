...
namespace QBForge.Provider.Clauses
{
    public class LeftJoinClause : BinaryClause
	{
		...
		public LeftJoinClause(TableClause tableClause, string labelAs) : this(tableClause, new OnClause(), labelAs) { }
		public LeftJoinClause(SubQueryClause subQueryClause, string labelAs) : this(subQueryClause, new OnClause(), labelAs) { }
